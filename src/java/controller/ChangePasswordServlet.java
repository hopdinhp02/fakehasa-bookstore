 ...
 * @author This Pc
 */
@WebServlet(name="ChangeServlet", urlPatterns={"/customer-change-password"})
public class ChangePasswordServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(!oldPass.equals(a.getPassword())){
            ...
            request.setAttribute("ms", "Mật khẩu và Mật khẩu xác nhận không giống nhau!");
            request.getRequestDispatcher("change-password.jsp").forward(request, response);
            
        }else{
            request.setAttribute("ms", "Password has been changed!");
            DAO d = new DAO();
            a = d.changePass(a.getUsername(), newPass);
            session.setAttribute("account", a);
            Customer c = d.getCustomer(a.getUsername());

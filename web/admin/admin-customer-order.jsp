<%-- 
    Document   : admin-customer-order
    Created on : Oct 27, 2022, 9:25:21 PM
    Author     : This Pc
--%>
        ...
        <div class="container-fluid">
            <div class='row'>
                ...
                <div class="col-10">
                    ...
                    <h1>List of Orders of CustomerID#${requestScope.cus_id}</h1>
                    <form action="admin-customer-order">
                        <input type="hidden" name="id" value="${requestScope.cus_id}"/>
                        Tìm kiếm:
                        <select name="type">
                        ...
                        <div class="box">
                            <ul class="pagination">
                                <c:if test="${requestScope.page!=1}" >
                                    <li><a href="admin-customer-order?id=${requestScope.cus_id}&page=${requestScope.page-1}"><i class='bx bxs-chevron-left'></i></a></li>
                                        </c:if>  
                                        ...
                                        <li><a ${requestScope.page==i?"class='active'":""} href="admin-customer-order?id=${requestScope.cus_id}&page=${i}">${i}</a></li>
                                        </c:if>
                                    ...
                                    <li><a href="admin-customer-order?id=${requestScope.cus_id}&page=${requestScope.page+1}"><i class='bx bxs-chevron-right'></i></a></li>
                                        </c:if>
                            </ul>
                        </div>
                    </c:if>
